...
Route::group(['middleware'=> 'isadmin'], function(){
  ...
  Route::resource('/admin/user_result', 'UserResultReportController');
...
Route::get('/admin/funcao', 'FuncaoController@index');
Route::post('/admin/funcao', 'FuncaoController@store');
Route::post('/admin/funcao/{id}', 'FuncaoController@update');
Route::get('/admin/funcao/{id}', 'FuncaoController@destroy');

Route::get('/admin/matriz', 'MatrizController@index');
Route::post('/admin/matriz/{id}', 'MatrizController@store');
Route::delete('/admin/matriz/{id}', 'MatrizController@destroy');
